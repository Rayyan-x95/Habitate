...
/**
 * Data-layer AppTheme enum. Preserved for internal DataStore serialization.
 * The domain layer uses [com.ninety5.habitate.domain.model.AppTheme].
 */
enum class DataAppTheme {
    LIGHT, DARK, SYSTEM
}
